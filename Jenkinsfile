pipeline {
  ...
  stages {
    ...
    stage('Run dev container') {
      ...
      steps {
        sh 'docker run -p 3300:3000 -d --name eirbmon-front-dev -v /var/lib/docker/volumes/jenkins-data/_data/workspace/Game_dev/BuildInfo:/Front/public/BuildInfo/ -v /home/eirbmon/Documents/SharedFile:/src/build/contracts eirbmon/front-dev'
